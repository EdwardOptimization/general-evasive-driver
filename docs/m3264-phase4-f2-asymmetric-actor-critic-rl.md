...
- Verdict: f2_completed (full run: 16 training seeds [pass-8 hardening from 8], 20 drift and 30 avoidance validation episodes per training seed, training-seed-clustered CIs; engineering-only, incumbent unchanged, defers to PI review).
