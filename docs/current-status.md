...
design, not direct execution. The next task is M1707: design measured execution
artifacts, outcome/termination aggregates, resume handling, and task-quality
claim boundaries for the bounded calibration smoke.
