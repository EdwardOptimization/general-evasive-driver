...
replaced the stale paper-route state; this update folds in M3215-M3244,
...
and the M3244 C1-v3 residual-RL smoke).
...
M3215-M3244. `experiments/research_status.json` now records
3245 completed / 7 failed / 3 blocked task entries, with `next_task:
null`. On
...
checkpoint/metrics written; stage-1 still requires a separate preregistration),
D1b
...
M3223, M3224, M3225, M3226, M3227, M3228, M3229, M3230, M3231, M3232, M3233, M3234, M3235, M3236, M3237, M3238, M3239, M3240, M3241, M3242, and M3244 registered and
...
protocol smoke, M3242 completed the full B2b high-speed pricing negative, and
M3244 completed the C1-v3 residual-on-frozen-v4 PPO smoke); M3243 remains a
...
the first 1024-step smoke for that route and passed all quick gates. The next
admissible C1-v3 unit is a separate stage-1 preregistration with fixed v4 /
`v4_pertuned` / v4+residual / oracle readouts; no C2, C3, stage-1
performance, high-fidelity sufficiency, feasibility-proof, or self-ID claim is
admitted by M3244.
...
| Latest harness milestone (M3244: C1-v3 residual-RL smoke) | `docs/m3244-c1-v3-residual-rl-smoke.md` |
