...
## 20260522T154936Z - m261-repair-disciplined-stage2-repeat

- status: `completed`
- kind: `driver_candidate`
- run dir: `runs/m261_behavior_gate_a001_seed9506`
- artifact: `docs/m261-repair-disciplined-stage2-repeat.md`
...
## 20260523T050307Z - m309-exact-repaired-ppo-proposal-design

- status: `completed`
- kind: `infrastructure`
- run dir: `runs/m309_exact_repaired_ppo_proposal_design`
- artifact: `docs/m309-exact-repaired-ppo-proposal-design.md`
...
## 20260523T074745Z - m340-old-key-neighborhood-mining-design

- status: `completed`
- kind: `infrastructure`
- run dir: `docs/m340-old-key-neighborhood-mining-design.md`
- artifact: `docs/m340-old-key-neighborhood-mining-design.md`
...
## 20260524T093000Z - m585-bc5660-history-intervention-design

- status: `completed`
- kind: `infrastructure`
- run dir: ``
- artifact: `docs/m585-bc5660-history-intervention-design.md`
...
## 20260525T014500Z - m672-response-amplification-shadow-audit

- status: `completed`
- kind: `gate`
- run dir: ``
- artifact: `docs/m672-response-amplification-shadow-audit.md`
...
## 20260525T034500Z - m680-branch-specific-response-amplification-implementation

- status: `completed`
- kind: `infrastructure`
- run dir: `runs/m680_branch_specific_response_amplification`
- artifact: `docs/m680-branch-specific-response-amplification-implementation.md`
...
## 20260525T020000Z - m740-extreme-fault-distribution-v3-implementation

- status: `completed`
- kind: `infrastructure`
- run dir: `runs/m740_extreme_fault_distribution_v3`
- artifact: `docs/m740-extreme-fault-distribution-v3-implementation.md`
...
## 20260525T054000Z - m762-v4-sequence-objective-only-probe-audit

- status: `completed`
- kind: `gate`
- artifact: `docs/m762-v4-sequence-objective-only-probe-audit.md`
...
## 20260525T082000Z - m778-v4-limited-broader-residual-replay-audit

- status: `completed`
- kind: `gate`
- artifact: `docs/m778-v4-limited-broader-residual-replay-audit.md`
- result: M778 audits M777 as mechanism-positive but strict-normal-retention-failed. Alpha `0.2` improves intervention action gap mean/p10 from base `0.040348/0.025782` to `0.046317/0.027627`, improves margin gap mean from `0.029796` to `0.033918`, and keeps outcome sensitivity retention at `1.0`; reconstruction is `2640/2652` with `0` metadata misses and no actor/training/PPO/promotion mutation. The stricter M775 gate still fails because normal success drops to `0.995455` and normal collision rate becomes `0.004545`. All 12 normal collision rows come from one unique source (`seed 77025`, `source_index 12`, `step 24`, `halfshaft_torque_loss_proxy`, `drive_authority_drop->rear_lateral_authority_drop`) duplicated across three intervention variants and four horizons. The source has only `+0.000124` base margin, so alpha `0.2`'s small first-action drift `0.000380` flips it to `-0.000062`. M778 classifies the result as `behavior_regression` with `scenario_sampling_failure` risk, not a metric artifact or contract violation.
- decision: `admit_broader_normal_boundary_alpha_probe_design`
- next: `m779-v4-broader-normal-boundary-alpha-probe-design`

## 20260525T083000Z - m779-v4-broader-normal-boundary-alpha-probe-design

- status: `completed`
- kind: `infrastructure`
- artifact: `docs/m779-v4-broader-normal-boundary-alpha-probe-design.md`
...
## 20260525T104000Z - m790-v4-vector-residual-calibration-audit

- status: `completed`
- kind: `gate`
- artifact: `docs/m790-v4-vector-residual-calibration-audit.md`
...
## 20260526T000000Z - m842-v4-low-margin-new-data-route-third-branch-synthesis

- status: `completed`
- kind: `gate`
- artifact: `docs/m842-v4-low-margin-new-data-route-third-branch-synthesis.md`
...
## 20260525T184401Z - m877-v4-pair-delta-corpus-dedup-resplit-implementation

- status: `completed`
- kind: `infrastructure`
- run dir: `runs/m877_v4_pair_delta_corpus_dedup_resplit`
- artifact: `docs/m877-v4-pair-delta-corpus-dedup-resplit-implementation.md`
...
## 20260525T193652Z - m887-v4-enriched-pair-delta-objective-only-probe-audit

- status: `completed`
- kind: `gate`
- artifact: `docs/m887-v4-enriched-pair-delta-objective-only-probe-audit.md`
...
## 20260525T224851Z - m935-v4-public-base-policy-level-trust-region-branch-synthesis

- status: `completed`
- kind: `gate`
- artifact: `docs/m935-v4-public-base-policy-level-trust-region-branch-synthesis.md`
...
## 20260526T001432Z - m949-v4-public-base-controlled-fusion-rejected-branch-retention-probe

- status: `completed`
- kind: `infrastructure`
- run dir: `runs/m949_v4_public_base_controlled_fusion_rejected_branch_retention_probe`
- artifact: `docs/m949-v4-public-base-controlled-fusion-rejected-branch-retention-probe.md`
...
## 20260526T030821Z - m960-v4-public-base-low-tail-direction-family-target-audit-implementation

- status: `completed`
- kind: `gate`
- run dir: `runs/m960_v4_public_base_low_tail_direction_family_target_audit`
- artifact: `docs/m960-v4-public-base-low-tail-direction-family-target-audit-implementation.md`
