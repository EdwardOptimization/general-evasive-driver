...
M91-H: repeat a smaller regularized learned-history encoder across seeds.
M91-I: implement minimum-set sensor ablations.
M91-J: freeze a PPO recipe and run P0/P1 RL comparison.
M91-K: run matched hidden-dynamics wrong-history gates.
```
