...
split-mu expressibility audit only, M3226 adds a 60 s same-episode
drive-structure smoke only, and M3227 adds a Chrono multi-vehicle
direction-pricing proxy only. Fine for the scoped self-ID science; the gap map
below is what C5's population claim must close.
