...
Sedan/TMeasy E3 tire-truth telemetry connector smoke, M3255 adds the full
Sedan/TMeasy E3 detector-latency and recovery-budget verdict, and M3257 adds
the E3-fix detector-onset reconciliation trace panel: 24/24 case rows, 3426
trace rows, original early-fire rate 0.5, reconciled early-fire rate 0.0,
detector miss rate 0.1667, and Track F still not admitted before E2'
confirmation plus a later GPU-days checkpoint. Fine for the scoped self-ID
science; the gap map below is what C5's population claim must close.
