...
readout. M3260 adds the first Chrono drift/beyond-saturation pricing panel:
204 rows on Sedan/TMeasy, 20 validation units per drift cell, one positive
low-mu power-oversteer oracle gap (+0.4000 vs tuned reflex, CI95
[0.1797, 0.6203]) and one near-neutral lift-off recovery gap (+0.0500,
CI95 [-0.0480, 0.1480]). M3261 adds F1 training-infrastructure coverage only:
48 mixed avoidance/drift Chrono worker steps, finite obs72/action3 torch update,
2.1031 steps/s, and a projected 100M-step wall-clock of 13207.81 h / 550.33
days. F2/F3 remain blocked on PI wall-clock review; there is still no learned-
...
| scenario geometry | family #1 B2K2 (r=900 arc commitment) and family #2 F2C1 (straight asymmetric gap choice), both deeply measured; legacy r=18 drift circle, figure-eight, M3082 4-axis panel; M3223 adds a flagged constant-velocity crosser smoke with deterministic replay and preserved legacy zero-relvel contracts; M3240 prices the current moving-crosser outcome panel negative (0/4 cells qualified); M3260 prices two low-mu Chrono circle drift cells with sideslip/yaw/rear-tire saturation telemetry | S-curves, multi-obstacle (4 obs slots, only slot 0 ever used), oncoming traffic, lane-change topologies; any new moving-obstacle or drift topology needs a new preregistered outcome panel |
