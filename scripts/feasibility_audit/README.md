...
Index of every script in this directory (43 as of 2026-06-12), mapped to its
...
| `c5prime_c1_oracle_bc_warmstart.py` | `experiments/feasibility_audit/c5prime_c1_oracle_bc_prereg.json`, `c5prime_c1_oracle_bc_warmstart_quick.json`, `c5prime_c1_oracle_bc_warmstart.json`; `runs/feasibility_audit/c5prime_c1_oracle_bc_warmstart/full/checkpoint.pt`, `dataset.npz` | `docs/m3228-c1-c5prime-oracle-demo-bc-warmstart.md` | Does the first CP-1-opened C1 structured-oracle demo + BC warm-start pass its frozen held-out action-MSE gate? No: quick passed, but full validation action MSE was 0.234184 vs the <=0.12 gate; C1 remains open and C2 is not admitted. |
