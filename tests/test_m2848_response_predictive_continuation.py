...
from autodrift.engineering_controller_route_a_response_predictive_recurrent_belief_core_training_bounded_continuation_preflight import (
...
def test_m2848_response_target_schema_includes_only_ego_response_targets():
...
def test_m2848_parameter_trace_rejects_actor_mean_only(tmp_path):
    ...
    candidate_state["response_prediction_head.bias"] = torch.ones(4)
