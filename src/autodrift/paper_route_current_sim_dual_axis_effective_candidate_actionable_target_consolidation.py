"""Artifact-only consolidation for M2399 effective-candidate localization."""
...
DEFAULT_SOURCE_DIR = Path("runs/m2399_paper_route_current_sim_dual_axis_effective_candidate_measured_outcome_localization")
DEFAULT_OUTPUT_DIR = Path("runs/m2401_paper_route_current_sim_dual_axis_effective_candidate_actionable_target_consolidation")
DEFAULT_TARGET_SLICE_ROW_COUNT = 1313
DEFAULT_MINIMUM_ACTIONABLE_EPISODE_COUNT = 30
DEFAULT_NEXT_BLOCKER = "m2402-paper-route-current-sim-dual-axis-effective-candidate-actionable-target-consolidation-result-audit"
RESULT_PASS = "current_sim_dual_axis_effective_candidate_actionable_target_consolidation_pass"
RESULT_FAIL = "current_sim_dual_axis_effective_candidate_actionable_target_consolidation_incomplete_or_fail"
...
ACTIONABILITY_CLASS_BY_AXIS = {
    ...
    "repair_family": "repair_family_surface",
    "repair_family+hidden_dynamics_bucket": "repair_family_conditioned_hidden_dynamics",
    "repair_family+role_family": "repair_family_conditioned_role",
    "source_slice_value": "source_slice_surface",
    "source_slice_axis+source_slice_value": "source_slice_surface",
}
EXTRA_FIELDNAMES = [
    "effective_candidate_target_consolidation",
...
def consolidate_slice_row(
    ...
    *,
    ...
    return {
        ...
        "effective_candidate_target_consolidation": True,
...
def claim_boundary_rows() -> list[dict[str, Any]]:
    return [
        {
            "claim": "artifact_only_effective_candidate_actionable_target_consolidation",
            "admissible": True,
            "reason": "M2401 may claim only target and guardrail artifact materialization from M2399 slices",
        },
        {
            "claim": "effective_candidate_ranking",
            "admissible": False,
            "reason": "candidate-specific slices are diagnostic guardrails, not rankings",
        },
        {
        ...
        },
        {
            ...
            "admissible": False,
            "reason": "M2401 does not select or promote a winner",
        },
        {
            "claim": "paper_level_benchmark_result",
            "admissible": False,
            "reason": "M2401 is artifact consolidation, not a paper-level result",
        },
        {
            "claim": "finite_window_vs_gru_conclusion",
            "admissible": False,
            "reason": "M2401 does not run a finite-window-vs-GRU verdict protocol",
        },
        {
            "claim": "level3_self_identification",
            "admissible": False,
            "reason": "M2401 does not run history interventions",
        },
        {
            "claim": "scenario_redesign_executed",
            "admissible": False,
            "reason": "M2401 does not modify or execute redesigned scenarios",
        },
        {
            "claim": "training_repair_success",
            "admissible": False,
            "reason": "M2401 does not train, repair, replay, or run PPO",
        },
        {
            "claim": "current_sim_verdict",
            "admissible": False,
            "reason": "M2401 consolidates one localization artifact and does not make a current-sim verdict",
        },
    ]
...
def run_effective_candidate_actionable_target_consolidation(
    *,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    summary = run_effective_candidate_actionable_target_consolidation(
