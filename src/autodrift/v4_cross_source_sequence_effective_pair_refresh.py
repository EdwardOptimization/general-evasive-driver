"""No-training cross-source sequence-effective pair refresh."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run no-training v4 cross-source sequence-effective pair refresh.")
    ...
    parser.add_argument("--reconstructed-snapshot-rows", type=Path, required=True)
    ...
    parser.add_argument("--max-obstacle-distance", type=float, default=0.10)
    ...
    parser.add_argument("--min-pair-candidate-rows", type=int, default=40)
    parser.add_argument("--min-reconstructed-pair-rows", type=int, default=20)
    parser.add_argument("--min-pair-delta-rows", type=int, default=30)
    ...
    parser.add_argument("--max-pairs-per-left-seed", type=int, default=32)
    parser.add_argument("--max-pairs-per-fault-family-pair", type=int, default=24)
    parser.add_argument("--max-pairs-per-left-fault-family", type=int, default=40)
    ...
    summary = run_cross_source_sequence_effective_pair_refresh(
        ...
        reconstructed_snapshot_rows_path=args.reconstructed_snapshot_rows,
        ...
        min_reconstructed_pair_rows=int(args.min_reconstructed_pair_rows),
        min_pair_delta_rows=int(args.min_pair_delta_rows),
