...
| `env.py` build_env (rung-0 pretrain bridge) | ✅ done — model-injected env resets+steps+obs72, smoke-passing |
| build_env rung-1+ (scenario->params generalization) | ⬜ (rung-1 RED cert; low pri) |
